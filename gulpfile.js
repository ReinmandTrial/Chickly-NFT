...
import { push } from "./config/gulp-tasks/push.js";
import { metadata } from "./config/gulp-tasks/metadata.js";
...
// Основные задачи будем выполнять параллельно после обработки шрифтов
const buildTasks = gulp.series(fonts, jsDev, js, gulp.parallel(html, push, metadata, css, images, gitignore));
